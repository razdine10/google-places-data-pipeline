...
, final AS (
    SELECT
      ...
      , ROUND(
            (rating * 15)
          + (LEAST(positive_sentiment_pct / 4, 20))
          + (CASE WHEN reviews_collected >= 5 THEN 5 ELSE 0 END)
        , 1) AS quality_score
