...
SELECT 
  ...
  , CASE 
        WHEN relative_time_description LIKE '%jour%' OR relative_time_description LIKE '%day%' THEN 'Recent'
        WHEN relative_time_description LIKE '%semaine%' OR relative_time_description LIKE '%week%' THEN 'This Week'
        WHEN relative_time_description LIKE '%mois%' OR relative_time_description LIKE '%month%' THEN 'This Month'
        WHEN relative_time_description LIKE '%an%' OR relative_time_description LIKE '%year%' THEN 'This Year'
        ELSE 'Old'
